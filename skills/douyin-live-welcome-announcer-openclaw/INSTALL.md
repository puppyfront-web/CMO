...
这个 skill 用于在 `macOS` 或 `Windows` 上监听抖音直播间网页，并对进房用户做语音欢迎播报。

适用场景：

- 用手机开播
- 用 Mac 或 Windows 电脑打开抖音直播间网页
- 用 OpenClaw 调起这个 skill 做欢迎播报
...
3. 确保浏览器停留在你自己的真实直播间页面，不要停在 `https://live.douyin.com/` 首页推荐流。
...
```text
用 douyin_live_welcome_announcer 帮我启动抖音直播间欢迎播报
```

或者：

```text
帮我运行抖音直播欢迎播报 skill，并监听我的直播间链接
```
